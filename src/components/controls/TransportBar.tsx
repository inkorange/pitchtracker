...
export function TransportBar({ flightDuration, speed = 0.5, onProgressChange }: TransportBarProps) {
  ...
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 px-4 py-2 rounded-lg bg-white/[0.06] backdrop-blur-md border border-white/10 shadow-lg">
      <button
        onClick={togglePlay}
