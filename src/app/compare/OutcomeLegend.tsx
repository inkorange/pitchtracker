...
export function OutcomeLegend() {
  return (
    <aside className="hidden sm:block absolute top-20 right-6 z-20 rounded-lg bg-black/50 backdrop-blur-md border border-white/10 shadow-lg p-3 pointer-events-auto">
